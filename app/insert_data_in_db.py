...
from database import add_new_data, engine
from models import Base, Ingredient, IngredientsInRecipe, Recipe
...
several_ingredients = [
    ...
    Ingredient(
        ingredient_name="Мука ржаная", ingredient_description="любая"
    ),
